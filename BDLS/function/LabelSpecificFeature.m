      function [Pre_Labels,Outputs]=LabelSpecificFeature(cv_test_data,cv_test_target,cv_train_data,cv_train_target,model_BDLS,model_MLL)
       if model_MLL.type == 0 % Whether to extract label-specific features yes=1 no=0;

            Outputs       = cv_test_data*model_BDLS;
          
            fscore        = cv_train_data*model_BDLS;
